...
if(isset($_GET['tId'])){
  ...
  if(!$transaction_id){
    ...
    // Proceed with transaction get request
  ...
  $nodeLines = "
    ...
    file_put_contents("_PATH", $nodelines);
    echo shell_exec("path/to/node/file.js"); // run as escape shell args to prevent and CLRF server
    echo"Transaction complete. Thank you for using AlgoJS!";
  }
}
?>
